<?php
    ...
    */
    ...
    require_once 'classes/abstraits/Animal.php';
    require_once 'classes/abstraits/Carnivore.php';
    require_once 'classes/concrets/Canin.php';
    require_once 'classes/abstraits/Felin.php';
    require_once 'classes/concrets/Lion.php';
    require_once 'classes/concrets/Jaguar.php';
    /*
